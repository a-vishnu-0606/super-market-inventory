...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="row mt-3">
			<button class="col-md-1 float-right btn btn-primary btn-sm" id="new_receiving"><b> New Receiving</b></button>
		</div>
		<div class="row mt-3">
			<div class="col-md-12">
				<div class="card">
						...
						<table class="table table-bordered">
							...
							?>
								<tr>
									...
									<td class=""><b><?php echo date("M d, Y",strtotime($row['date_added'])) ?></b></td>
									<td class=""><b><?php echo $row['ref_no'] ?></b></td>
									<td class=""><b><?php echo isset($sup_arr[$row['supplier_id']])? $sup_arr[$row['supplier_id']] :'N/A' ?></b></td>
									<td class="text-center">
										<a class="btn btn-sm btn-primary" href="index.php?page=manage_receiving&id=<?php echo $row['id'] ?>"><b>Edit</b></a>
										<a class="btn btn-sm btn-danger delete_receiving" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><b>Delete</b></a>
									</td>
								</tr>
							<?php endwhile; ?>
							</tbody>
